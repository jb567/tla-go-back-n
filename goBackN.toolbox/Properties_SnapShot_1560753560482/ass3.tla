...
Fairness == /\ sender!Fairness
            ...
            /\ receiver!Fairness
            /\ SF_vars(/\ Next
                       /\ \E x \in 1..Len(dataWireOut'): dataWireOut'[x] # CORRUPT_DATA /\ Len(dataWireOut'[x]) > 0 /\ dataWireOut'[x][1] = ackSeqNum + 1
                      )
...
\* Last modified Mon Jun 17 18:39:09 NZST 2019 by jb567
